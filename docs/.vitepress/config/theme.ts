        ...
        '/guide/': [
            {
                ...
                items: [
                    ...
                    { text: t('Getting Started'), link: `${urlPrefix}/guide/getting-started.md` },
                ],
            },
            {
                text: t('Recipes'),
                items: [
                    { text: t('Multiple builds'), link: `${urlPrefix}/guide/multiple-builds.md` },
                ],
            },
        ],
        '/reference/': [
            {
                text: t('Reference'),
                items: [
                    { text: t('Config Options'), link: `${urlPrefix}/reference/config-options.md` },
                    { text: t('Command Line Interface'), link: `${urlPrefix}/reference/cli.md` },
                ],
            },
        ],
    }
